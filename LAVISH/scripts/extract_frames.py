...
if __name__ == '__main__':
    ...
    parser.add_argument('--out_dir', dest='out_dir', type=str, default='/data1/yyp/AVEL/LAVISH/AVE_frame')
    parser.add_argument('--video_path', dest='video_path', type=str, default='/data1/yyp/AVEL/VGG/AVE_dataset/AVE_Dataset/AVE')
