    ...
    for vid in tqdm(vids):
        ...
        for sec in range(10):
            ...
            for frame_path in frames_selected:
                ...
                # 新增 resize_pad 方式
                img_rp = resize_and_pad(img_ori, target_size=224)  # 注意传入的是 PIL.Image
        ...
        if std_resize_features.shape[0] != 10 or scale_center_features.shape[0] != 10 or scale_rd_features.shape[0] != 10 or inception_features.shape[0] != 10 or longer_side_resize_features.shape[0] != 10:
